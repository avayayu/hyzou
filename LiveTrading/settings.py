...
# Symbol suffix to be used for requresting data from yahoo (e.g. '.AX' for ASX stuff)
SYMBOL_SUFFIX = ''
# Source of historical data, can be 'yahoo' or 'poloniex'
HISTORICAL_DATA_SOURCE = 'yahoo'
